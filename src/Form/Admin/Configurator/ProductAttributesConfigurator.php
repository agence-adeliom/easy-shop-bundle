 ...
 */
final class ProductAttributesConfigurator implements FieldConfiguratorInterface
{
    public function supports(FieldDto $field, EntityDto $entityDto): bool
    {
        return ProductAttributesField::class === $field->getFieldFqcn();
    }

    public function configure(FieldDto $field, EntityDto $entityDto, AdminContext $context): void
    {
        if (null !== $entryTypeFqcn = $field->getCustomOptions()->get(ProductAttributesField::OPTION_ENTRY_TYPE)) {
        ...
        $field->setFormTypeOption('allow_drag', $field->getCustomOptions()->get(ProductAttributesField::OPTION_ALLOW_DRAG));
        $field->setFormTypeOption('allow_add', $field->getCustomOptions()->get(ProductAttributesField::OPTION_ALLOW_ADD));
        $field->setFormTypeOption('allow_delete', $field->getCustomOptions()->get(ProductAttributesField::OPTION_ALLOW_DELETE));
        ...
        $field->setFormTypeOptionIfNotSet('entry_options.label', $field->getCustomOptions()->get(ProductAttributesField::OPTION_SHOW_ENTRY_LABEL));
        ...
        if (null === $field->getCustomOption(ProductAttributesField::OPTION_ENTRY_IS_COMPLEX)) {
            $definesEntryType = null !== $entryTypeFqcn = $field->getCustomOption(ProductAttributesField::OPTION_ENTRY_TYPE);
            ...
            $field->setCustomOption(ProductAttributesField::OPTION_ENTRY_IS_COMPLEX, $isComplexEntry);
        }
