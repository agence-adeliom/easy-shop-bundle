...
{
    public function __construct(private readonly SenderInterface $emailSender, private readonly ?\Sylius\Bundle\CoreBundle\Mailer\OrderEmailManagerInterface $decoratedEmailManager)
    {
